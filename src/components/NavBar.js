...
const NavBar = () => {
    ...
    return (
        <Flex backgroundColor="#57b6ff" flexDir="row" alignItems="center" justifyContent="space-between"
            pl="2rem" pr="2rem" py="10px" >
            <Icon fill="white" cursor="pointer" as={MdMenu} w={30} h={30}
                onClick={() => openMenu()} >
            </Icon>
            <Link to="/" >
                <Image src="https://cdn.shopify.com/s/files/1/0472/5705/9496/files/Logologo_1.svg?v=1610055540" w={100} h={70} />
            </Link>
            <Box>
